...
urdf_path = os.path.join("iiwa_description", "urdf", "iiwa7.urdf")  # Replace with the path to your URDF file
...
# End-effector frame
end_effector_frame = model.getFrameId("iiwa_link_7")  # Replace with your end-effector frame name
